...
let darktwittericon = document.getElementById("darktwittericon1");
...
form.addEventListener("submit", (e) => {
  ...
  async function getAllProducts() {
    try {
      ...
      let userdate = ouruser.created_at;

      datee.textContent = userdate;
      ...
      if (ouruser.location) {
        ...
        locationn.textContent = "Not Avaliable";
      ...
      if (ouruser.company) {
        ...
        company1.textContent = "Not Avaliable";
        company1.style.opacity = 0.5;
        if (company1.className == "location") {
      ...
      if (ouruser.blog) {
        ...
        blogg.textContent = "Not Avaliable";
      ...
      if (ouruser.bio && ouruser.bio.length > 100) {
        bio1.style.fontSize = "12px";
      }
      if (ouruser.company.length > 40) {
        company1.style.fontSize = "12px";
      }
      ...
      if (ouruser.twitter_username) {
        twitter1.style.opacity = 1;
        twitter1.textContent = ouruser.twitter_username;
        if (twitter1.className == "twitter") {
          twitericon.style.opacity = 1;
        } else {
          darktwittericon.style.opacity = 1;
        }
      } else {
        twitter1.textContent = "Not Avaliable";
        twitter1.style.opacity = 0.5;
        if (twitter1.className == "twitter") {
          twitericon.style.opacity = 0.5;
        } else {
          darktwittericon.style.opacity = 0.5;
        }
      }
    } catch (error) {
      console.log(error);
...
btn.addEventListener("click", () => {
  ...
  twitericon.style.opacity = 0;
  if (twitter1.textContent == "Not Avaliable") {
    darktwittericon.style.opacity = 0.5;
  } else {
    darktwittericon.style.opacity = 1;
  }
...
darkbtn.addEventListener("click", () => {
  ...
  darktwittericon.style.opacity = 0;
  if (twitter1.textContent == "Not Avaliable") {
    twitericon.style.opacity = 0.5;
  } else {
    twitericon.style.opacity = 1;
